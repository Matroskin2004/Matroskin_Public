...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        """Метод делает запрос к API сервера и возвращает статус запроса и результат в формате JSON
         с уникальным ключем пользователя, наденного по указанным email и паролем"""
    ...
    def get_list_of_pets(self, auth_key, filter: str = "") -> json:
        ...
        со списком найденных питомцев, совпадающих с фильтром. На данный момент фильтр
        пустое значение - получить список всех питомцев, либо 'my_pets' - получить список моих питомцев0"""
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет (постит) на сервер данные фото питомца и возвращает статус
